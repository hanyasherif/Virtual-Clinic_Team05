...
const {addAdminstrator, removeUser, viewDoctors, selectDoctor, filterDoctors} = require("./Routes/userController");
...
app.get("/selectDoctor/:id",selectDoctor);
app.get("/filterDoctors/:id",filterDoctors);
